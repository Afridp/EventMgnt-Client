        ...
        <div className="px-4 mx-auto max-w-screen-xl text-left py-24 lg:py-56">
          {/* <Fade delay={100}>
            ...
            <p className="mb-8 text-sm font-extralight text-gray-300 lg:text-xl ">
              ...
              accusamus expedita quaerat, a ipsa necessitatibus fugit atque
          ...
          <div className="flex flex-col space-y-4  sm:flex-row sm:justif-left sm:space-y-0">
            {/* <Fade delay={800}>
              ...
              <Link
                href="#"
                className="inline-flex justify-center hover:text-gray-900 items-center py-3 px-5 sm:ms-4 text-base font-medium text-center text-white border border-white hover:bg-gray-100 focus:ring-2 focus:ring-gray-400"
              >
                Learn more
              </Link>
            </Fade> */}
